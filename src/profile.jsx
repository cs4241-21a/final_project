                ...
                <ul class="input_area_list">
                    ...
                    <li class="input_field_item">
                        ...
                        <select name="classes" id="class_name" class="selectpicker" multiple data-live-search="true" onChange={this.update_selected_courses}>
                            ...
                            <option value="1102">CS 1102: Accelerated introduction to program design</option>
                            <option value="2011">CS 2011: Introduction to machine organization and assembly language</option>
                            <option value="2022">CS 2022: Discrete mathematics</option>
                            <option value="2102">CS 2102: Object-oriented design concepts</option>
                            <option value="2103">CS 2103: Accelerated object-oriented design concepts</option>
                            <option value="2119">CS 2119: Application building with object-oriented concepts</option>
                            <option value="2223">CS 2223: Algorithms</option>
                            <option value="2301">CS 2301: Systems programming for non-majors</option>
                            ...
                            <option value="3043">CS 3043: Social implications of information processing</option>
                            <option value="3133">CS 3133: Foundations of computer science</option>
                            ...
                            <option value="4032">CS 4032: Numerical methods for linear and nonlinear systems</option>
                            <option value="4033">CS 4033: Numerical methods for calculus and differential equations</option>
                            <option value="4100">CS 4100: Artificial intelligence for interactive media andgames</option>
                            <option value="4120">CS 4120: Analysis of algorithms</option>
                            <option value="4123">CS 4123: Theory of computation</option>
                            <option value="4233">CS 4233: Object-oriented analysis and design</option>
                            <option value="4241">CS 4241: Webware - Computational technology for network information systems</option>
                            ...
                            <option value="4404">CS 4404: Tools and techinques in computer network security</option>
                            <option value="4432">CS 4432: Database systems II</option>
                            <option value="4445">CS 4445: Data mining and knowledge discovery in databases</option>
                            ...
                            <option value="4518">CS 4518: Mobile and ubiquitous computing</option>
                            <option value="4533">CS 4533: Techniques of programming language translation</option>
                            <option value="4536">CS 4536: Programming languages</option>
                            <option value="4731">CS 4731: Computer graphics</option>
                            <option value="4801">CS 4801: Introduction to cryptography and communication security</option>
                            <option value="4802">CS 4802: Biovisualization</option>
                            <option value="4803">CS 4803: Biological and biomedical database mining</option>
                        </select>
                    </li>
