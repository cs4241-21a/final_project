...
/*
let corsOptions = {
  origin: 'https://wpi-clicker.herokuapp.com/'
}

app.use(cors(corsOptions))
*/
/*
var allowlist = ['https://wpi-clicker.herokuapp.com/', 'https://web-ware-final.herokuapp.com/']
...
app.use(function(req, res, next) {
  ...
  res.setHeader('Access-Control-Allow-Origin', "https://web-ware-final.herokuapp.com");
...
// DB SETUP
const uri = "mongodb+srv://"+process.env.DBUSERNAME+":"+process.env.DBPASSWORD+"@cluster0.c2xcj.mongodb.net";
console.log(uri);
...
.then(() => {
  ...
  return client.db("final").collection("scores");
})
.then(__collection => {
...
io.on('connection', (socket) => {
  ...
  socket.on('update', (updateData) => {
    ...
    if(updateData.production === [] || updateData.production === null){
